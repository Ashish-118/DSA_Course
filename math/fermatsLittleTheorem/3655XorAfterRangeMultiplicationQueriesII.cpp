// Approach - Using Square Root Decomposition, Difference Array Technique with
// Jumps + Fermat's Little Theorem + Binary Exponentiation T.C : O((N + Q)√N)
// due to splitting queries by step size, S.C : O(N + Q) for storing diff arrays
// and grouped queries.
class Solution
{
public:
